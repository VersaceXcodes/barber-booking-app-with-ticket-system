      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full mb-6">
            <Check className="w-12 h-12 text-master-text-primary-dark" />
          </div>
          ...
          <div className="space-y-6">
            ...
            {ticketNumber && (
              <div className="bg-gradient-to-br from-amber-500/20 to-orange-500/20 border border-amber-500/30 rounded-xl p-6 text-center">
                <p className="text-master-text-secondary-dark mb-2">Your Booking Reference</p>
            ...
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold text-master-text-primary-dark mb-3">
                A Master Fade Barber Will Come To Your Address
              </h2>
              <p className="text-master-text-secondary-dark leading-relaxed">
            ...
            <div className="border-t border-white/20 pt-6">
              <h3 className="text-xl font-bold text-master-text-primary-dark mb-4">What Happens Next?</h3>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-amber-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-master-text-primary-dark text-sm font-bold">1</span>
                  </div>
                  <div>
                    <p className="text-master-text-primary-dark font-medium">Confirmation Email</p>
                    <p className="text-master-text-muted-dark text-sm">You'll receive an email with your booking details</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-amber-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-master-text-primary-dark text-sm font-bold">2</span>
                  </div>
                  <div>
                    <p className="text-master-text-primary-dark font-medium">Barber Assignment</p>
                    <p className="text-master-text-muted-dark text-sm">We'll assign an expert barber to your appointment</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-amber-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-master-text-primary-dark text-sm font-bold">3</span>
                  </div>
                  <div>
                    <p className="text-master-text-primary-dark font-medium">Reminder</p>
                    <p className="text-master-text-muted-dark text-sm">You'll get a reminder before your appointment</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-amber-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-master-text-primary-dark text-sm font-bold">4</span>
                  </div>
                  <div>
                    <p className="text-master-text-primary-dark font-medium">Service Day</p>
                    <p className="text-master-text-muted-dark text-sm">Your barber arrives at the scheduled time</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Important Notes */}
            <div className="border-t border-white/20 pt-6">
              <h3 className="text-xl font-bold text-master-text-primary-dark mb-3">Important Notes</h3>
              <ul className="space-y-2 text-master-text-secondary-dark">
        ...
        >
          <button
            onClick={() => navigate('/')}
            className="flex-1 px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-master-text-primary-dark rounded-lg font-bold hover:shadow-lg hover:shadow-amber-500/50 transition-all flex items-center justify-center gap-2"
          >
