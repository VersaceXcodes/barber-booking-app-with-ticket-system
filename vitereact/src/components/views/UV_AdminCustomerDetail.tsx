    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-[#2A0A0A] via-[#3D0F0F] to-[#5C1B1B] py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Error States */}
          {profileError && (
            <div className="mb-6 bg-red-50 border border-red-200 text-red-300 px-4 py-3 rounded-lg">
            ...
            <div className="space-y-6">
              {loadingProfile ? (
                <div className="animate-pulse space-y-6">
                  <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-xl shadow-lg h-64"></div>
                  <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-xl shadow-lg h-64"></div>
                </div>
              ) : customerProfile ? (
                <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 border border-white/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
                    >
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-[#2D0808] divide-y divide-gray-200">
                      {customerBookings.map((booking) => (
                        <tr key={booking.booking_id} className="hover:bg-gradient-to-br from-[#2A0A0A] via-[#3D0F0F] to-[#5C1B1B] transition-colors">
                          <td className="px-6 py-4 whitespace-nowrap">
                            <Link
                              to={`/admin/bookings/${booking.ticket_number}`}
                              className="text-sm font-medium text-amber-400 hover:text-blue-700"
                            >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-right text-sm">
                            <Link
                              to={`/admin/bookings/${booking.ticket_number}`}
                              className="text-amber-400 hover:text-blue-700 font-medium"
                            >
                              View Details
                            </Link>
                          </td>
      ...
      {showDeleteNoteModal && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 p-4">
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-xl shadow-2xl max-w-md w-full">
            ...
            <div className="px-6 py-4 bg-gradient-to-br from-[#2A0A0A] via-[#3D0F0F] to-[#5C1B1B] flex justify-end gap-3 rounded-b-xl">
              <button
