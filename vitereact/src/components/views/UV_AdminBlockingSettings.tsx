                ...
                {!cancelBookingsAction ? (
                  <div className="space-y-4">
                    <button
                      ...
                      className="w-full bg-amber-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-amber-700 transition-all"
                    >
                      Block anyway (keep bookings)
                    </button>
                    <button
                      onClick={() => setCancelBookingsAction(true)}
                      className="w-full bg-red-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-red-700 transition-all"
                    >
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full bg-red-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-red-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
