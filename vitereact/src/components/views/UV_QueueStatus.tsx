    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#2A0A0A] via-[#3D0F0F] to-[#5C1B1B] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white text-xl">Loading queue status...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#2A0A0A] via-[#3D0F0F] to-[#5C1B1B] flex items-center justify-center px-4">
        <div className="max-w-md w-full backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-white mb-3">Queue Not Found</h1>
          <p className="text-gray-300 mb-6">
            We couldn't find your queue status. You may have already been served or left the queue.
          </p>
          <button
            onClick={() => navigate('/')}
            className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg font-bold hover:shadow-lg transition-all"
          >
            Back to Home
          </button>
        </div>
          ...
          <div className="space-y-6">
              ...
              <div className={`bg-gradient-to-br from-${statusColor}-500/20 to-${statusColor}-600/20 border border-${statusColor}-500/30 rounded-xl p-6 text-center`}>
                <div className="flex items-center justify-center gap-8">
                  <div>
                    ...
                    <p className="text-5xl font-bold text-white">#{queueStatus.position}</p>
                  </div>
                  <div className="h-16 w-px bg-white/20"></div>
                  <div>
                    <p className="text-gray-300 mb-2">Estimated Wait</p>
                    <p className="text-5xl font-bold text-white">{queueStatus.estimated_wait_minutes}<span className="text-2xl text-gray-300">min</span></p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white/10 rounded-lg p-4 flex items-center gap-3">
                ...
                <div>
                  <p className="text-gray-400 text-sm">Total in Queue</p>
                  <p className="text-2xl font-bold text-white">{queueStatus.total_in_queue}</p>
                </div>
              </div>
              <div className="bg-white/10 rounded-lg p-4 flex items-center gap-3">
            ...
            <div className="border-t border-white/20 pt-6">
              <div className="flex items-center gap-3 text-gray-300">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">{queueStatus.customer_phone}</p>
                </div>
              </div>
            </div>
