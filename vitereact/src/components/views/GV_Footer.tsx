          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="space-y-4">
              ...
              <nav className="flex flex-col space-y-3">
                <Link
                  to="/book/service"
                  className="text-gray-300 hover:text-white transition-colors text-sm py-1 inline-block"
                >
                  Book Appointment
                </Link>
                <Link
                ...
                {showAdminLoginLink && (
                  <Link
                    to="/admin/login"
                    className="text-gray-400 hover:text-gray-300 transition-colors text-xs py-1 inline-block"
                  >
                    Admin Login
                  </Link>
                )}
